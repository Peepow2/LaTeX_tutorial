...
<ul>
    <li><p><strong>$.....$</strong> --> พิมพ์สมการตรง ..... </p></li>
    <li><strong>$$.....$$</strong> --> พิมพ์สมการตรง ..... จะทำให้สมการที่พิมพ์  "อยู่กลางหน้ากระดาษ" </li>
    <li><strong> ใช้ { ..... } </strong> --> เพื่อจัดกลุ่มสมการ เช่น x^{2a+b} ไม่ใช่ x^2a+b </li>
</ul>
